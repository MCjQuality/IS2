...
public class MenuConsumerContext {
	                           ...
	                           ExchangeProposalHandler exchangeProposals, ClosedSetHandler closedSets, Scanner scanner)
	{
		...
		actions.put(Constants.NUMBER_2_MESSAGE, new FormulateProposalController(hierarchies, consumer, conversionElements,
				exchangeProposals, closedSets, scanner));
		actions.put(Constants.NUMBER_3_MESSAGE, new WithdrawnProposalController(consumer, exchangeProposals, scanner));
		actions.put(Constants.NUMBER_4_MESSAGE, new ShowConsumerProposalsController(consumer, exchangeProposals, scanner));
